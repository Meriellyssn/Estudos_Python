...
minimo = salario * 30/ 100 #Regra de negócio, a parcela não pode ser superior a 30% do salário.
...
if prestacao <= minimo:
    ...
    print(f'Prestação de R$ {prestacao:.2f} excede o limite de R$ {minimo:.2f} para o salário informado!')
